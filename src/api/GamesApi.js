...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/BoxScore', 'model/Game', 'model/GameMedia', 'model/GameWeather', 'model/PlayerGame', 'model/TeamGame', 'model/TeamRecord', 'model/Week'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/BoxScore'), require('../model/Game'), require('../model/GameMedia'), require('../model/GameWeather'), require('../model/PlayerGame'), require('../model/TeamGame'), require('../model/TeamRecord'), require('../model/Week'));
  } else {
    // Browser globals (root is window)
    if (!root.cfb) {
      root.cfb = {};
    }
    root.cfb.GamesApi = factory(root.cfb.ApiClient, root.cfb.BoxScore, root.cfb.Game, root.cfb.GameMedia, root.cfb.GameWeather, root.cfb.PlayerGame, root.cfb.TeamGame, root.cfb.TeamRecord, root.cfb.Week);
  }
}(this, function(ApiClient, BoxScore, Game, GameMedia, GameWeather, PlayerGame, TeamGame, TeamRecord, Week) {
  'use strict';
