...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PlayerSearchResult', 'model/PlayerSeasonStat', 'model/PlayerUsage', 'model/PortalPlayer', 'model/ReturningProduction'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/PlayerSearchResult'), require('../model/PlayerSeasonStat'), require('../model/PlayerUsage'), require('../model/PortalPlayer'), require('../model/ReturningProduction'));
  } else {
    // Browser globals (root is window)
    if (!root.cfb) {
      root.cfb = {};
    }
    root.cfb.PlayersApi = factory(root.cfb.ApiClient, root.cfb.PlayerSearchResult, root.cfb.PlayerSeasonStat, root.cfb.PlayerUsage, root.cfb.PortalPlayer, root.cfb.ReturningProduction);
  }
}(this, function(ApiClient, PlayerSearchResult, PlayerSeasonStat, PlayerUsage, PortalPlayer, ReturningProduction) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * Transfer portal by season
     * @param {Number} year Year filter
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Array.<module:model/PortalPlayer>} and HTTP response
     */
    this.getTransferPortalWithHttpInfo = function(year) {
      var postBody = null;
     ...
     * Transfer portal by season
     * @param {Number} year Year filter
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Array.<module:model/PortalPlayer>}
     */
    this.getTransferPortal = function(year) {
      return this.getTransferPortalWithHttpInfo(year)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
