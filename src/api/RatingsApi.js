...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ConferenceSPRating', 'model/TeamEloRating', 'model/TeamSPRating', 'model/TeamSRSRating'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/ConferenceSPRating'), require('../model/TeamEloRating'), require('../model/TeamSPRating'), require('../model/TeamSRSRating'));
  } else {
    // Browser globals (root is window)
    if (!root.cfb) {
      root.cfb = {};
    }
    root.cfb.RatingsApi = factory(root.cfb.ApiClient, root.cfb.ConferenceSPRating, root.cfb.TeamEloRating, root.cfb.TeamSPRating, root.cfb.TeamSRSRating);
  }
}(this, function(ApiClient, ConferenceSPRating, TeamEloRating, TeamSPRating, TeamSRSRating) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {Object} opts.seasonType Maximum season type to consider (defaults to regular if week is specified else defaults to postseason)
