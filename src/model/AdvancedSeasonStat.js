...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AdvancedSeasonStatOffense'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AdvancedSeasonStatOffense'));
  } else {
    // Browser globals (root is window)
    if (!root.cfb) {
      root.cfb = {};
    }
    root.cfb.AdvancedSeasonStat = factory(root.cfb.ApiClient, root.cfb.AdvancedSeasonStatOffense);
  }
}(this, function(ApiClient, AdvancedSeasonStatOffense) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('defense'))
        obj.defense = AdvancedSeasonStatOffense.constructFromObject(data['defense']);
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/AdvancedSeasonStatOffense} defense
   */
