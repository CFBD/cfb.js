...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.cfb.CoachSeasons = factory(root.cfb.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CoachSeasons model module.
   * @module model/CoachSeasons
   * @version 4.4.11
   */

  /**
   * Constructs a new <code>CoachSeasons</code>.
   * @alias module:model/CoachSeasons
   * @class
   */
  ...
  /**
   * Constructs a <code>CoachSeasons</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CoachSeasons} obj Optional instance to populate.
   * @return {module:model/CoachSeasons} The populated <code>CoachSeasons</code> instance.
   */
