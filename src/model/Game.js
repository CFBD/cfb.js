...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('home_division'))
        obj.homeDivision = ApiClient.convertToType(data['home_division'], 'String');
      ...
      if (data.hasOwnProperty('home_pregame_elo'))
        obj.homePregameElo = ApiClient.convertToType(data['home_pregame_elo'], 'Number');
      if (data.hasOwnProperty('home_postgame_elo'))
        obj.homePostgameElo = ApiClient.convertToType(data['home_postgame_elo'], 'Number');
      ...
      if (data.hasOwnProperty('away_division'))
        obj.awayDivision = ApiClient.convertToType(data['away_division'], 'String');
      ...
      if (data.hasOwnProperty('away_pregame_elo'))
        obj.awayPregameElo = ApiClient.convertToType(data['away_pregame_elo'], 'Number');
      if (data.hasOwnProperty('away_postgame_elo'))
        obj.awayPostgameElo = ApiClient.convertToType(data['away_postgame_elo'], 'Number');
  ...
  /**
   * @member {String} homeDivision
   */
  exports.prototype.homeDivision = undefined;
  ...
  /**
   * @member {Number} homePregameElo
   */
  exports.prototype.homePregameElo = undefined;

  /**
   * @member {Number} homePostgameElo
   */
  exports.prototype.homePostgameElo = undefined;
  ...
  /**
   * @member {String} awayDivision
   */
  exports.prototype.awayDivision = undefined;
  ...
  /**
   * @member {Number} awayPregameElo
   */
  exports.prototype.awayPregameElo = undefined;

  /**
   * @member {Number} awayPostgameElo
   */
  exports.prototype.awayPostgameElo = undefined;
