...
export class Play {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('home_timeouts'))
        obj.homeTimeouts = ApiClient.convertToType(data['home_timeouts'], 'Number');
      if (data.hasOwnProperty('away_timeouts'))
        obj.awayTimeouts = ApiClient.convertToType(data['away_timeouts'], 'Number');
 ...
 */
Play.prototype.homeTimeouts = undefined;

/**
 * @member {Number} awayTimeouts
 */
Play.prototype.awayTimeouts = undefined;
