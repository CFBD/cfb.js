...
export class PlayStat {
  ...
  static constructFromObject(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('secondsRemaining'))
        obj.secondsRemaining = ApiClient.convertToType(data['secondsRemaining'], 'Number');
 ...
 */
PlayStat.prototype.secondsRemaining = undefined;
