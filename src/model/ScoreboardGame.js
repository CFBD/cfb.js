...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ScoreboardGameBetting', 'model/ScoreboardGameHomeTeam', 'model/ScoreboardGameVenue', 'model/ScoreboardGameWeather'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ScoreboardGameBetting'), require('./ScoreboardGameHomeTeam'), require('./ScoreboardGameVenue'), require('./ScoreboardGameWeather'));
  } else {
    // Browser globals (root is window)
    if (!root.cfb) {
      root.cfb = {};
    }
    root.cfb.ScoreboardGame = factory(root.cfb.ApiClient, root.cfb.ScoreboardGameBetting, root.cfb.ScoreboardGameHomeTeam, root.cfb.ScoreboardGameVenue, root.cfb.ScoreboardGameWeather);
  }
}(this, function(ApiClient, ScoreboardGameBetting, ScoreboardGameHomeTeam, ScoreboardGameVenue, ScoreboardGameWeather) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('homeTeam'))
        obj.homeTeam = ScoreboardGameHomeTeam.constructFromObject(data['homeTeam']);
      if (data.hasOwnProperty('awayTeam'))
        obj.awayTeam = ScoreboardGameHomeTeam.constructFromObject(data['awayTeam']);
   ...
   */
  exports.prototype.situation = undefined;
  ...
  /**
   * @member {module:model/ScoreboardGameHomeTeam} homeTeam
   */
  exports.prototype.homeTeam = undefined;

  /**
   * @member {module:model/ScoreboardGameHomeTeam} awayTeam
   */
