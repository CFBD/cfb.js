...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TeamMatchupGames'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TeamMatchupGames'));
  } else {
    // Browser globals (root is window)
    if (!root.cfb) {
      root.cfb = {};
    }
    root.cfb.TeamMatchup = factory(root.cfb.ApiClient, root.cfb.TeamMatchupGames);
  }
}(this, function(ApiClient, TeamMatchupGames) {
  'use strict';
