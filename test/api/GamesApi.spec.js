    ...
    describe('GamesApi', function() {
      ...
      describe('getGameWeather', function() {
        it('should call getGameWeather successfully', function(done) {
          ...
          instance.getGameWeather(opts).then(function(data) {
            // TODO: update response assertions
            let dataCtr = data;
            expect(dataCtr).to.be.an(Array);
            expect(dataCtr).to.not.be.empty();
            for (let p in dataCtr) {
              ...
              expect(data.startTime).to.be.a('string');
              expect(data.startTime).to.be("");
              expect(data.gameIndoors).to.be.a('boolean');
              expect(data.gameIndoors).to.be(false);
              expect(data.homeTeam).to.be.a('string');
              expect(data.homeTeam).to.be("");
              expect(data.homeConference).to.be.a('string');
              expect(data.homeConference).to.be("");
      ...
      describe('getGames', function() {
        it('should call getGames successfully', function(done) {
          ...
          opts.conference = "conference_example";
          opts.division = "division_example";
          opts.id = 56;
          ...
          instance.getGames(year, opts).then(function(data) {
            ...
            for (let p in dataCtr) {
              ...
              expect(data.homeConference).to.be.a('string');
              expect(data.homeConference).to.be("");
              expect(data.homeDivision).to.be.a('string');
              expect(data.homeDivision).to.be("");
              ...
              expect(data.homePregameElo).to.be.a('number');
              expect(data.homePregameElo).to.be(0);
              expect(data.homePostgameElo).to.be.a('number');
              expect(data.homePostgameElo).to.be(0);
              ...
              expect(data.awayConference).to.be.a('string');
              expect(data.awayConference).to.be("");
              expect(data.awayDivision).to.be.a('string');
              expect(data.awayDivision).to.be("");
              ...
              expect(data.awayPregameElo).to.be.a('number');
              expect(data.awayPregameElo).to.be(0);
              expect(data.awayPostgameElo).to.be.a('number');
              expect(data.awayPostgameElo).to.be(0);
      ...
      describe('getScoreboard', function() {
        it('should call getScoreboard successfully', function(done) {
          ...
          instance.getScoreboard(opts).then(function(data) {
            // TODO: update response assertions
            let dataCtr = data;
            expect(dataCtr).to.be.an(Array);
            expect(dataCtr).to.not.be.empty();
            for (let p in dataCtr) {
              ...
              expect(data.situation).to.be.a('string');
              expect(data.situation).to.be("");
              expect(data.possession).to.be.a('string');
              expect(data.possession).to.be("");
              expect(data.venue).to.be.a(cfb.ScoreboardGameVenue);
                    expect(data.venue.name).to.be.a('string');
                expect(data.venue.name).to.be("");
                expect(data.venue.city).to.be.a('string');
                expect(data.venue.city).to.be("");
                expect(data.venue.state).to.be.a('string');
                expect(data.venue.state).to.be("");
              expect(data.homeTeam).to.be.a(cfb.ScoreboardGameHomeTeam);
                    expect(data.homeTeam.id).to.be.a('number');
                expect(data.homeTeam.id).to.be(0);
                expect(data.homeTeam.name).to.be.a('string');
                expect(data.homeTeam.name).to.be("");
                expect(data.homeTeam.conference).to.be.a('string');
                expect(data.homeTeam.conference).to.be("");
                expect(data.homeTeam.classification).to.be.a('string');
                expect(data.homeTeam.classification).to.be("");
                expect(data.homeTeam.points).to.be.a('number');
                expect(data.homeTeam.points).to.be(0);
              expect(data.awayTeam).to.be.a(cfb.ScoreboardGameHomeTeam);
                    expect(data.awayTeam.id).to.be.a('number');
                expect(data.awayTeam.id).to.be(0);
                expect(data.awayTeam.name).to.be.a('string');
                expect(data.awayTeam.name).to.be("");
                expect(data.awayTeam.conference).to.be.a('string');
                expect(data.awayTeam.conference).to.be("");
                expect(data.awayTeam.classification).to.be.a('string');
                expect(data.awayTeam.classification).to.be("");
                expect(data.awayTeam.points).to.be.a('number');
                expect(data.awayTeam.points).to.be(0);
              expect(data.weather).to.be.a(cfb.ScoreboardGameWeather);
                    expect(data.weather.temperature).to.be.a('number');
                expect(data.weather.temperature).to.be();
                expect(data.weather.description).to.be.a('string');
                expect(data.weather.description).to.be("");
                expect(data.weather.windSpeed).to.be.a('number');
                expect(data.weather.windSpeed).to.be();
                expect(data.weather.windDirection).to.be.a('number');
                expect(data.weather.windDirection).to.be();
              expect(data.betting).to.be.a(cfb.ScoreboardGameBetting);
                    expect(data.betting.spread).to.be.a('number');
                expect(data.betting.spread).to.be();
                expect(data.betting.overUnder).to.be.a('number');
                expect(data.betting.overUnder).to.be();
                expect(data.betting.homeMoneyline).to.be.a('number');
                expect(data.betting.homeMoneyline).to.be(0);
                expect(data.betting.awayMoneyline).to.be.a('number');
                expect(data.betting.awayMoneyline).to.be(0);
            }
            ...
            for (let p in dataCtr) {
              ...
              expect(data.id).to.be(0);
              {
                ...
                for (let p in dataCtr) {
                  ...
                  expect(data.schoolId).to.be.a('number');
                  expect(data.schoolId).to.be(0);
                  expect(data.school).to.be.a('string');
                  expect(data.school).to.be("");
                  expect(data.conference).to.be.a('string');
                  expect(data.conference).to.be("");
        ...
        it('should call getTeamRecords successfully', function(done) {
          ...
          instance.getTeamRecords(opts).then(function(data) {
            ...
            for (let p in dataCtr) {
              ...
              expect(data.expectedWins).to.be.a('number');
              expect(data.expectedWins).to.be();
