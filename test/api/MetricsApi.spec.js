...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MetricsApi', function() {
      describe('getFGEP', function() {
        it('should call getFGEP successfully', function(done) {
          // TODO: uncomment getFGEP call and complete the assertions
          /*

          instance.getFGEP().then(function(data) {
            ...
            for (let p in dataCtr) {
              let data = dataCtr[p];
              expect(data).to.be.a(cfb.FieldGoalExpectedPoints);
              ...
              expect(data.expectedPoints).to.be.a('number');
              expect(data.expectedPoints).to.be();
            }
