        ...
        it('should call getVenues successfully', function(done) {
          ...
          instance.getVenues().then(function(data) {
            ...
            for (let p in dataCtr) {
              ...
              expect(data.location).to.be.a(cfb.VenueLocation);
                    expect(data.location.x).to.be.a('number');
                expect(data.location.x).to.be();
                expect(data.location.y).to.be.a('number');
                expect(data.location.y).to.be();
              expect(data.elevation).to.be.a('number');
              expect(data.elevation).to.be();
              expect(data.yearConstructed).to.be.a('number');
              expect(data.yearConstructed).to.be(0);
