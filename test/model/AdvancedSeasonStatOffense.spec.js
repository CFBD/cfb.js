  ...
  describe('(package)', function() {
    describe('AdvancedSeasonStatOffense', function() {
      ...
      it('should have the property totalOpportunies (base name: "totalOpportunies")', function() {
        // TODO: update the code to test the property totalOpportunies
        expect(instance).to.have.property('totalOpportunies');
        // expect(instance.totalOpportunies).to.be(expectedValueLiteral);
      });
