...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BoxScorePlayersUsage', function() {
      beforeEach(function() {
        instance = new cfb.BoxScorePlayersUsage();
      });

      it('should create an instance of BoxScorePlayersUsage', function() {
        // TODO: update the code to test BoxScorePlayersUsage
        expect(instance).to.be.a(cfb.BoxScorePlayersUsage);
      });
