...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Play', function() {
      ...
      it('should have the property homeTimeouts (base name: "home_timeouts")', function() {
        // TODO: update the code to test the property homeTimeouts
        expect(instance).to.have.property('homeTimeouts');
        // expect(instance.homeTimeouts).to.be(expectedValueLiteral);
      });

      it('should have the property awayTimeouts (base name: "away_timeouts")', function() {
        // TODO: update the code to test the property awayTimeouts
        expect(instance).to.have.property('awayTimeouts');
        // expect(instance.awayTimeouts).to.be(expectedValueLiteral);
      });
