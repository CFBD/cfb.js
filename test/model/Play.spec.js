...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Play', function() {
      ...
      it('should have the property defensePoints (base name: "defense_points")', function() {
        // TODO: update the code to test the property defensePoints
        expect(instance).to.have.property('defensePoints');
        // expect(instance.defensePoints).to.be(expectedValueLiteral);
      });
