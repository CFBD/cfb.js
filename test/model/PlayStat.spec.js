...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PlayStat', function() {
      ...
      it('should have the property secondsRemaining (base name: "secondsRemaining")', function() {
        // TODO: update the code to test the property secondsRemaining
        expect(instance).to.have.property('secondsRemaining');
        // expect(instance.secondsRemaining).to.be(expectedValueLiteral);
      });
