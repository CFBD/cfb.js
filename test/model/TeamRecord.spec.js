  ...
  describe('(package)', function() {
    describe('TeamRecord', function() {
      ...
      it('should have the property expectedWins (base name: "expectedWins")', function() {
        // TODO: update the code to test the property expectedWins
        expect(instance).to.have.property('expectedWins');
        // expect(instance.expectedWins).to.be(expectedValueLiteral);
      });
